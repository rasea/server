...
public class MaintenanceService extends AbstractWebService {
	...
	public void addApplication(@WebParam(name = "application") final Application application,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
	...
	@WebMethod
	public void addOperation(@WebParam(name = "application") final String application,
	...
	@WebMethod
	public void addPermission(@WebParam(name = "application") final String application,
			@WebParam(name = "resource") final Resource resource,
			@WebParam(name = "operation") final Operation operation,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
	...
	@WebMethod
	public void addResource(@WebParam(name = "application") final String application,
			@WebParam(name = "resource") final Resource resource,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
		try {
	...
	@WebMethod
	public void assignOwner(@WebParam(name = "application") final String application,
	...
	@WebMethod
	public void deassignOwner(@WebParam(name = "application") final String application,
			@WebParam(name = "username") final String username,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
		try {
	...
	@WebMethod
	public void deleteOperation(@WebParam(name = "application") final String application,
			@WebParam(name = "operation") final String operation,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
		try {
			this.checkAuthentication(header);
	...
	@WebMethod
	public void deletePermission(@WebParam(name = "application") final String application,
			@WebParam(name = "resource") final Resource resource,
			@WebParam(name = "operation") final Operation operation,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
	...
	@WebMethod
	public void deleteResource(@WebParam(name = "application") final String application,
			@WebParam(name = "resource") final String resource,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
		try {
			this.checkAuthentication(header);
	...
	public Operation operationDetail(@WebParam(name = "application") final String application,
			@WebParam(name = "operation") final String operation,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
	...
	public Resource resourceDetail(@WebParam(name = "application") final String application,
			@WebParam(name = "resource") final String resource,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
	...
	public List<Operation> resourceOperations(
