...
public class ManagementService extends AbstractWebService {
	...
	@WebMethod
	public void addRole(@WebParam(name = "application") final String application,
	...
	@WebMethod
	public void addUser(@WebParam(name = "user") final User user,
	...
	@WebMethod
	public void assignUser(@WebParam(name = "application") final String application,
	...
	@WebMethod
	public void deassignUser(@WebParam(name = "application") final String application,
			@WebParam(name = "username") final String username,
			@WebParam(name = "role") final String role,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
	...
	@WebMethod
	public void deleteRole(@WebParam(name = "application") final String application,
			@WebParam(name = "role") final String role,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
		try {
	...
	@WebMethod
	public void disableRole(@WebParam(name = "application") final String application,
			@WebParam(name = "role") final String role,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
	...
	@WebMethod
	public void enableRole(@WebParam(name = "application") final String application,
			@WebParam(name = "role") final String role,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
		// TODO Auto-generated method stub
	...
	@WebMethod
	public void grantPermission(@WebParam(name = "application") final String application,
			@WebParam(name = "permission") final Permission permission,
			@WebParam(name = "role") final String role,
			@WebParam(name = "allowed") final boolean allowed,
			@WebParam(header = true, name = "raseaServiceHeader") final RaseaServiceHeader header)
			throws WebServiceException {
		try {
			this.checkAuthentication(header);
			...
			final org.rasea.core.entity.Permission perm = new org.rasea.core.entity.Permission(resource,
					operation);
