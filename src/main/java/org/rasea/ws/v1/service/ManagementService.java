...
public class ManagementService extends AbstractWebService {
	...
	@WebMethod
	public void addRole(final RoleRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		try {
	...
	@WebMethod
	public void addUser(final UserRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		try {
			this.checkAuthentication(credentials);
	...
	@WebMethod
	public void assignUser(final UserRoleRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		try {
			this.checkAuthentication(credentials);
	...
	@WebMethod
	public void deassignUser(final UserRoleRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		try {
			this.checkAuthentication(credentials);
			this.checkPermission(credentials, "member", Constants.DEFAULT_OPERATION_UPDATE);
	...
	@WebMethod
	public void deleteRole(final RoleNameRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		try {
			this.checkAuthentication(credentials);
	...
	@WebMethod
	public void deleteUser(final SimpleUserNameRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		try {
			this.checkAuthentication(credentials);
	...
	@WebMethod
	public void disableRole(final RoleNameRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		// TODO Auto-generated method stub

	}

	@WebMethod
	public void disableUser(final SimpleUserNameRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		// TODO Auto-generated method stub

	}

	@WebMethod
	public void enableRole(final RoleNameRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		// TODO Auto-generated method stub

	}

	@WebMethod
	public void enableUser(final SimpleUserNameRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		// TODO Auto-generated method stub

	}

	@WebMethod
	public void grantPermission(final GrantPermissionRequest param, @WebParam(header = true) final Credentials credentials)
	...
	@WebMethod
	public void revokePermission(final AuthorizationRequest param, @WebParam(header = true) final Credentials credentials) throws WebServiceException {
		try {
			this.checkAuthentication(credentials);
			this.checkPermission(credentials, "authorization", Constants.DEFAULT_OPERATION_UPDATE);
